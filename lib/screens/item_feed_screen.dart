...
class _ItemFeedScreenState extends ConsumerState<ItemFeedScreen> {
                  ...
                  if (_contentOpacity < 1.0)
                    AnimatedOpacity(
                      ...
                      child: Container(
                        color:
                            Colors
                                .transparent, // Transparent to show VibeBackground
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20),
  ...
  Widget _buildSliverContent(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Icon(
                    PhosphorIconsDuotone.folderPlus,
                    size: 60,
    ...
    switch (_viewMode) {
      case ViewMode.square:
        return SliverGrid(
          delegate: SliverChildBuilderDelegate(
            (context, index) => _buildContentCardRefactored(
              items[index],
              getBadge(items[index]),
              categories,
              isGrid: true,
              forceSquare: true,
            ),
      ...
      case ViewMode.feed:
        return SliverList(
          ...
          delegate: SliverChildBuilderDelegate(
            (context, index) => Padding(
              padding: const EdgeInsets.only(bottom: 24),
              child: _buildContentCardRefactored(
                items[index],
                getBadge(items[index]),
                categories,
                isGrid: false,
  ...
  Widget _buildContentCardRefactored(
    ItemModel item,
    String badgeText,
    List<CategoryModel> categories, {
    ...
    final hasImage =
        ...
        !item.displayImage!.toLowerCase().endsWith('.svg');
              ...
              child:
                  isNote
                      ...
                      : ShaderMask(
                        ...
                        child:
                            iconWidget, // Use widget directly, ShaderMask works on Icon and FaIcon
                      ),
            ),
    ...
    return LongPressDraggable<ItemModel>(
      ...
      delay: const Duration(
        milliseconds: 300,
      ), // Short delay to prevent accidental drags
      dragAnchorStrategy:
                  ...
                  children: [
                    ...
                    if (isNote && !hasImage)
                      ...
                      item.displayImage!.startsWith('http')
                          ...
                          ? Image.memory(
                            const Base64Decoder().convert(
                              item.displayImage!.substring(23),
                            ),
                            fit: BoxFit.cover,
                          )
